...
export const tarotClasses: TarotClassProduct[] = [
  ...
  },
  {
    ...
    transformations: [
      {
        title: "가이드북 펼치기, 이제 그만",
        description:
          "리딩할 때 책 뒤적이기 NO. 36장 키워드를 머릿속에서 바로 꺼내 씁니다.",
      },
      {
        title: "아침 루틴에 타로 한 스푼",
        description:
          "매일 아침 2~3장만 뽑아 오늘 흐름, 주의할 포인트, 뭐 하면 좋을지 딱 정리.",
      },
      {
        title: "친구 연애 고민? 이젠 내가 답함",
        description:
          "모호한 위로 대신, 뼈 때리는 직설 조언을 당당히 건네는 그 사람이 됩니다.",
      },
    ],
    curriculumIntro:
